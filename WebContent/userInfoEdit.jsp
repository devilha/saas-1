...
<body>
	<div title="修改个人信息" align="center"> 
		<table id="userInfoForm" cellpadding="5" style="line-height:20px; text-align:left; border:none; font-size:12px"> 
			...
			<tr>
				<td colspan="8" align="left" ><div align="center"><img src="images/sure.jpg" border="0" onclick="saveUserInfo();" /><img src="images/back.jpg" onclick="backMain();" style="margin-left:40px;"/></div></td>
			</tr>			
		</table> 
	</div>
</body>
