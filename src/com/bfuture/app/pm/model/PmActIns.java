...
@Entity
@Table(name="pm_act_ins")
public class PmActIns extends BaseObject implements Serializable {
  	private static final long serialVersionUID = -1387239586941335047L;
	private String id;
    private String ptC;
    private String paC;
    private String ppiC;
