...
@Entity
@Table(name="pm_pro_ins")
public class PmProIns extends BaseObject implements Serializable {

	private static final long serialVersionUID = -3450140187075370914L;
	private String id;
    private String ppiC;
    private String ptC;
